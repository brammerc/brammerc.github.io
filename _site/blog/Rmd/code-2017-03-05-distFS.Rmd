...
<html lang="en-us">
  ...
  <title>
      ...
      Distance freestyle split (in)consistency &middot; Swim Performance Analytics
...
<div class="sidebar">
  <div class="container">
    ...
    <div class="content container">
      <div class="post">
  <h1 >Distance freestyle split (in)consistency</h1>
  <span class="post-date">05 Mar 2017 | <i class="fa fa-tags" style="font-size: .8em"></i> 
    <a href="http://localhost:4000/archive/tags/#lowess" style="font-size: 16px;">lowess&nbsp;</a>
  
    <a href="http://localhost:4000/archive/tags/#application" style="font-size: 16px;">application&nbsp;</a>
    </span>
  
  Distance freestyle split variability is not well understood. There are some important questions related to this topic that the swimming community might ask: Do swimmer employ different 'split strategies'? If so, is split strategy related to performance (ie, do slower swimmers have a different strategy than faster swimmers?). If so, then does a slower swimmer that adopts the 'better' strategy improve her/his performance?  
...
<div id="share-bar">
	...
	<div class="share-buttons">
	    <a  href="https://www.facebook.com/sharer/sharer.php?u=http://localhost:4000//blog/Rmd/code-2017-03-05-distFS.Rmd"
	        onclick="window.open(this.href, 'pop-up', 'left=20,top=20,width=500,height=500,toolbar=1,resizable=0'); return false;"
	        title="Share on Facebook" >
	        <i class="fa fa-facebook-official share-button"> facebook</i>
	    </a>

	    <a  href="https://twitter.com/intent/tweet?text=Distance freestyle split (in)consistency&url=http://localhost:4000//blog/Rmd/code-2017-03-05-distFS.Rmd"
	        onclick="window.open(this.href, 'pop-up', 'left=20,top=20,width=500,height=500,toolbar=1,resizable=0'); return false;"
	        title="Share on Twitter" >
	        <i class="fa fa-twitter-share share-button"> twitter</i>
	    </a>

	    <a  href="http://www.reddit.com/submit?url=http://localhost:4000//blog/Rmd/code-2017-03-05-distFS.Rmd"
	        onclick="window.open(this.href, 'pop-up', 'left=20,top=20,width=900,height=500,toolbar=1,resizable=0'); return false;"
	        title="Share on Reddit" >
	        <i class="fa fa-reddit-alien share-button"> reddit</i>
	    </a>

	    <a  href="https://www.linkedin.com/shareArticle?mini=true&url=http://localhost:4000//blog/Rmd/code-2017-03-05-distFS.Rmd&title=Distance freestyle split (in)consistency&summary=&source=webjeda"
	        onclick="window.open(this.href, 'pop-up', 'left=20,top=20,width=500,height=500,toolbar=1,resizable=0'); return false;"
	        title="Share on LinkedIn" >
	        <i class="fa fa-linkedin-share share-button"> linkedin</i>
	    </a>

	    <a  href="mailto:?subject=Distance freestyle split (in)consistency&amp;body=Check out this site http://localhost:4000//blog/Rmd/code-2017-03-05-distFS.Rmd"
...
<!--- 
<a  href="https://plus.google.com/share?url=http://localhost:4000//blog/Rmd/code-2017-03-05-distFS.Rmd"
	        onclick="window.open(this.href, 'pop-up', 'left=20,top=20,width=500,height=500,toolbar=1,resizable=0'); return false;"
	        title="Share on Google+" >
	        <i class="fa fa-google-plus share-button"> google</i>
	    </a>

	    <a  href="http://pinterest.com/pin/create/button/?url=http://localhost:4000//blog/Rmd/code-2017-03-05-distFS.Rmd"
	        onclick="window.open(this.href, 'pop-up', 'left=20,top=20,width=900,height=500,toolbar=1,resizable=0'); return false;"
	        title="Share on Pinterest" >
	        <i class="fa fa-pinterest-p share-button"> pinterest</i>
	    </a>

	    <a  href="http://www.tumblr.com/share/link?url=http://localhost:4000//blog/Rmd/code-2017-03-05-distFS.Rmd"
	        onclick="window.open(this.href, 'pop-up', 'left=20,top=20,width=900,height=500,toolbar=1,resizable=0'); return false;"
...
<!---
  <span class="post-date">05 Mar 2017 |  
  <span class="graybuttontag">
    <a href="http://localhost:4000/archive/tags/#lowess" style="font-size: 16px;"><i class="fa fa-tags" style="font-size: .8em"></i>&nbsp;lowess</a>
  </span>&nbsp;
...
<div class="related">
	...
	<span class="related-posts">
		...
		<a href="http://localhost:4000/blog/tags/#lowess" title="lowess">lowess</a>&nbsp;
